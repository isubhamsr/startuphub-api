...
route.get('/logout/:id', adminAuth.logout)
...
route.get('/totalnews', adminVerify.isSuperAdmin, news.totalNews)
...
route.get('/fetchstartupideas', news.fetchStartupIdeaForUser)
